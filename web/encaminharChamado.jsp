...
<form name="form" action="/helpdesk/encaminharChamado.do">
<table align="center">
   <tr align="center">
	    <th >Selecione o técnico para o encaminhamento do chamado:</th>
    	<td>
		...
		<table align="right">
				<tr align="right">
					<td><input name="ok" class="input_button" type="submit" id="ok"
						value="OK"></td>
					<td><input type="button" class="input_button" name="cancelar" value="Cancelar"
