...
<table class="form" border="0" align="center" cellspacing="2"
  ...
  <tr>
    ...
    <th width="147"><input name="pergunta" type="text" size="80" maxlength="200"  value="${faq.pergunta}"></th>
  </tr>

  <tr>
    <th>Resposta: </th>
    <th><div align="left">
      <textarea name="resposta" cols="57" rows="10" >${faq.resposta}</textarea>
    </div></th>
  </tr>
   <tr>
	    <th>Tipo:</th>
   ...
   <tr >
	    <td colspan="2">
			  ...
			  onClick="this.form.action='/helpdesk/editarFaq.do';this.form.submit()">
