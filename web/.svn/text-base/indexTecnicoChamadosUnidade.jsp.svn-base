...
<jsp:include page="opcoes_escolher.jsp" flush="true" />

<p align="center" id="msg"> Lista de todos os chamados da ${unidade} </p>
  ...
  <c:forEach var="chamado" items="${chamados}" varStatus="posicao">
     <tr>
       ...
       <td width="10" align="center">
       	<a href="verChamadoTecnico.do?idChamado=${chamado.idChamado}">Detalhar</a>
       </td>
     </tr>
  </c:forEach>
</table>
