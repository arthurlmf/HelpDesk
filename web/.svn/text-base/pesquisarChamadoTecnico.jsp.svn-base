...
<p id="msg" class="msg">Pesquisar Chamado</p>
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><form id="form" name="form" action="/helpdesk/pesquisarChamadoTecnico.do">
          ...
          <th>
            <div align="left">
				<select name="estado" id="combo">
					...
					<option value="interencaminhamento">InterEncaminhado</option>
        ...
        <tr>
          <th colspan="2"><label>
            <div align="right">
              ...
              <input name="submeter" type="submit" id="submeter" value="Pesquisar Chamado" />
