...
public class CarregarGerenciarMinhaUnidade extends Action {
	...
	public ActionForward execute(ActionMapping map, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			...
			request.setAttribute(Constantes.UNIDADE, idUnidade);
			return map.findForward(Constantes.GERENCIAR_MINHA_UNIDADE);
