...
/**
 * Facade to acess system main functionalities
...
public class FacadeHelpDesk {
	...
	public void removerTipo(String idUnidade, String nomeTipo) throws HelpDeskException {
		system.removeTipo(idUnidade, nomeTipo);
	}

	public void removerSubtipo(String idUnidade, String nomeTipo, String nomeSubtipo) throws HelpDeskException {// removerSubtipo
																												// idUnidade=${idUnidade2}
																												// tipo="Psicologico"
																												// subtipo="Esquizofrenia"
		system.removerSubtipo(idUnidade, nomeTipo, nomeSubtipo);
	}

	public PrimaryKeySubTipo criarSubtipo(String idUnidade, String tipo, String subtipo, boolean temPatrimonio,
			int novoPrazoAtendimento) throws HelpDeskException {
	...
	public int solicitarChamado(String descricao, String tipo, String subtipo, String idPatrimonio,
			String unidadeSolicitante, String unidadeSuporte) throws HelpDeskException {
		return system.solicitarChamado(descricao, tipo, subtipo, idPatrimonio, unidadeSolicitante, unidadeSuporte);
	}
	...
	public int criarRelatorioVisita(int idChamado, String idTecnico, String intinerario, String imprevistos,
		...
		return system.criarRelatorioVisita(idChamado, idTecnico, intinerario, imprevistos, cabeamentoEstuturado,
				layoutDoAmbiente, tensaoDosEstabilizadores, instalacoesEletricas, limpezaDosMicros, tensaoDosNoBreaks,
				instalacoesFisicas, limpezaDasImpressoras, organizacaoDosCabos, imagensDosMicros, outrosString, outros,
				servicosRealizados, pendencias);
	...
	public List gerarRelatorio(String unidadeSolicitante, String unidadeAtendente, String tecnico, String ida,
		...
		return system.gerarRelatorio(unidadeSolicitante, unidadeAtendente, tecnico, ida, volta, tipo, subtipo, estado,
				patrimonio);
	}
