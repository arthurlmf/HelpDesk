...
/**
 * Classe que representao uma IntervencaoDAO
...
public class IntervencaoDAO extends AbstractDAO {
	...
	/**
	 * Insere um Intervencao no Banco de Dados um objeto na tabela correspondente.
	 * 
	 * @param intervencao O Intervencao a ser salvo no Banco de Dados
	 * @return O id do objeto criado no Banco de Dados
	 * @throws HelpDeskException caso ocorra algum erro
	 */
	public Serializable insert(Intervencao intervencao) throws HelpDeskException {
	 ...
	 * 
	 * @param intervencao O objeto a ser removido no Banco de Dados
	 * @throws HelpDeskException caso ocorra algum erro
	 */
	...
	/**
	 * Retorna uma lista de intervencaos do Banco de Dados com as caracteristicas
