 ...
 *  
 *  
 * Classe que representa uma Notificacao  de movimentacao
 * 
 * 
 * @author Arthur Farias 
 */
public class NotificacaoMovimentacao  {
	...
	private final String LETTERHEAD1 = "Informamos que houve uma intervenção no seu chamado de nº ";
	 ...
	 */
	public NotificacaoMovimentacao() {
		id_Chamado = data = hora = estado = tipo = descricao = tecnicoResponsavel = descricaoTransacao = id_Transacao = horaTransacao = datatransacao = "";
	...
	/**
	 * Retorna a representacao em string de uma NotificacaoMovimentacao
	 */
	public String toString() {
		return  delimitaString(LETTERHEAD1 + id_Chamado) + NEWLINE + NEWLINE
				...
				+ delimitaString(DESCRICAO + descricaoTransacao) + NEWLINE
	...
	/**
	 * @return Returns the descricaoTransacao.
	 */
